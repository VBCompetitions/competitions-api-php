...
final class Page
{
    public static function root(Config $config, Response $res) : Response
    {
        ...
        <script defer="defer" src="'.$config->getBasePath().'/ui/static/js/main.227f512c.js"></script>
        <link href="'.$config->getBasePath().'/ui/static/css/main.99e5422d.css" rel="stylesheet">
