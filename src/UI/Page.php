...
final class Page
{
    public static function root(Config $config, Response $res) : Response
    {
        ...
        <script defer="defer" src="'.$config->getBasePath().'/ui/static/js/main.0143106e.js"></script>
        <link href="'.$config->getBasePath().'/ui/static/css/main.34e8076a.css" rel="stylesheet">
