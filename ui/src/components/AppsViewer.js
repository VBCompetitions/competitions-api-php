...
import NewApp from '../dialogs/apps/NewApp'
import UpdateApp from '../dialogs/apps/UpdateApp'
import DeleteApp from '../dialogs/apps/DeleteApp'
...
export default function AppsViewer ({ setLoading, setSuccessMessage, setErrorMessage }) {
  ...
  return (
    <Box sx={{ padding: '10px' }}>
      ...
      { updateAppOpen ? <UpdateApp app={updateAppApp} setLoading={setLoading} closeDialog={closeUpdateApp} setSuccessMessage={setSuccessMessage} setErrorMessage={setErrorMessage}/> : null }
