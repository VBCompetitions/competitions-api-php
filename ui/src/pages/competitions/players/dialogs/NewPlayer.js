...
export default function NewPlayer ({ competitionID, setLoading, closeDialog, setSuccessMessage, setErrorMessage }) {
  ...
  return (
    <Dialog open={true} onClose={closeDialog} aria-labelledby='add new player'>
      ...
      <DialogContent>
        <br/>
        <TextField margin='dense' id='add-player-name' onChange={newPlayerNameChange} label='name (required)' type='text' fullWidth/>
        <TextField margin='dense' id='add-player-id' onChange={newPlayerIDChange} label='id' type='text' fullWidth/>
        <TextField margin='dense' id='add-player-number' onChange={newPlayerNumberChange} label='shirt number' type='number' fullWidth/>
        <TextField margin='dense' id='add-player-notes' onChange={newPlayerNotesChange} label='notes' type='text' fullWidth/>
      </DialogContent>
      <DialogActions>
