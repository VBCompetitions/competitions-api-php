...
function EditPlayerDialog ({ closeDialog, setSuccessMessage, setErrorMessage }) {
  ...
  <Dialog open={true} onClose={closeDialog} aria-labelledby='edit player'>
    ...
    <DialogContent>
      <br/>
      <TextField margin='dense' id='edit-player-name' onChange={newPlayerDialogNameChange} label='name (required)' type='text' fullWidth/>
      <TextField margin='dense' id='edit-player-id' onChange={newPlayerDialogIDChange} label='id' type='text' fullWidth/>
      <TextField margin='dense' id='edit-player-number' onChange={newPlayerDialogNumberChange} label='shirt number' type='number' fullWidth/>
      <TextField margin='dense' id='edit-player-notes' onChange={newPlayerDialogNotesChange} label='notes' type='text' fullWidth/>
    </DialogContent>
    <DialogActions>
